import { type FunctionalComponent, h, type SVGAttributes, type VNode } from "vue";
...
export const LoaderCircle: FunctionalComponent<SVGAttributes> = (
	_props,
	{ attrs },
) =>
	Icon("Loader Circle", [h("path", { d: "M21 12a9 9 0 1 1-6.219-8.56" })], attrs);
